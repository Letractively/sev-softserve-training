...
namespace OrderSystem.Models
{
    ...
    public partial class OrderSystemEntities : ObjectContext
    {
        ...
        public OrderSystemEntities()
            : base("name=OrderSystemEntities", "OrderSystemEntities")
        {
        ...
        /// </summary>
        public OrderSystemEntities(string connectionString)
            : base(connectionString, "OrderSystemEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Инициализация нового объекта OrderSystemEntities.
        /// </summary>
        public OrderSystemEntities(EntityConnection connection)
            : base(connection, "OrderSystemEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
